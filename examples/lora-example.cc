...
int main (int argc, char **argv)
{
  ...
  LogComponentEnable("MacLoraAca", LOG_LEVEL_INFO);
  // LogComponentEnable("LoraTxMode", LOG_LEVEL_INFO);
  // LogComponentEnable("LoraNetDevice", LOG_LEVEL_INFO);
  // LogComponentEnable("LoraPhyGen", LOG_LEVEL_INFO);
...
LoraExample::DoExamples ()
{
  ...
  LoraModesList mList;
  LoraTxMode mode = LoraTxModeFactory::CreateMode (LoraTxMode::LORA, 80, 80, 866000000, 150000, 2, "TestMode");
  ...
  LoraTxMode mode00 = LoraTxModeFactory::CreateMode (LoraTxMode::LORA, 300, 120, 866000010, 150000, 2, "TestMode00");
  LoraTxMode mode01 = LoraTxModeFactory::CreateMode (LoraTxMode::LORA, 300, 120, 866000050, 150000, 2, "TestMode01");
  LoraTxMode mode02 = LoraTxModeFactory::CreateMode (LoraTxMode::LORA, 300, 120, 866000100, 150000, 2, "TestMode02");
